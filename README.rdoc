...
2. try changing animations based on css animate rather than jquery animate. 

3. Cache-ing
  -Do client-side chaching of show pages for LoopCollections
  -Do cache-ing on first loop, just for kicks? 
  -Clean up static_pages controller in process
  
4. Complete namechange away from TTR

5. Make a 'random mode'
